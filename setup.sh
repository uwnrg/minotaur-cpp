...
sudo apt-get install build-essential libfontconfig1 mesa-common-dev libglu1-mesa-dev -y
...
sudo apt-get install libudev-dev libxi6 libsm6 libxrender1 libegl1-mesa -y
